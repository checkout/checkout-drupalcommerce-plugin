...
# Installation
You can find a full installation guide [here](https://github.com/checkout/checkout-drupalcommerce-plugin/wiki/Installation)
...
# URLs
In order to successfully complete 3D Secure transactions, and to keep Drupal order statuses in sync you need to configure the following URLs in your Checkout HUB as follows:

| Type | URL Example | Description |
| ------ | ------ | ------ |
| Redirections **Success**| _example.com_**/commerce_checkoutpayment/success** | Redirect after 3D Secure |
| Redirections **Fail**| _example.com_**/commerce_checkoutpayment/fail** | Redirect after 3D Secure |
| Webhook | _example.com_**/checkoutapi/process** | Sync Drupal |
